...
source.include_exts = py,png,jpg,kv,atlas,txt,ico,jpeg,ttf,otf,
...
requirements = python3,kivy==2.1.0, kivymd==1.1.1, sdl2_ttf==2.0.15, pillow, pyttsx3==2.97, gTTS==2.5.3, pygame==2.6.0, system_sounds==0.1.1
...
presplash.filename = Pub_application.gif

# (str) Icon of the application
icon.filename = page_image_acceuil.png
